...
export default function ISFJPage() {
  return (
    <div className="max-w-2xl mx-auto px-4 py-8">
      {/* 标题区 */}
      <h1 className="text-3xl font-bold mb-2">ISFJ（占位）性格概括</h1>
      ...
      <div className="space-y-6">
        <div>
          ...
          <div className="my-8 flex justify-center">
            <Image src="/images/entj.png" alt="ISFJイメージ" width={320} height={320} className="rounded-lg shadow-lg" />
          </div>
        </div>
        <div>
          <h2 className="text-xl font-semibold flex items-center">
      ...
      {/* 名人区 */}
      <div className="mt-10">
        <h2 className="text-xl font-semibold mb-4">有名なISFJタイプの人物</h2>
