...
export default function ENFPPage() {
  const content = personalityContent.enfp;
  ...
  return (
    <div className="max-w-2xl mx-auto px-4 py-8">
          ...
          <div key={index}>
            ...
            {index === 0 && (
              <div className="my-8 flex justify-center">
                <Image src="/images/enfp.png" alt="ENFPイメージ" width={320} height={320} className="rounded-lg shadow-lg" />
              </div>
            )}
          </div>
        ))}
      ...
      {/* 名人区 */}
      <div className="mt-10">
        <h2 className="text-xl font-semibold mb-4">ENFPの有名人</h2>
