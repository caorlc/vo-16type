...
export default function INTJPage() {
  const content = personalityContent.intj;
  ...
  return (
    <div className="max-w-2xl mx-auto px-4 py-8">
          ...
          <div key={index}>
            ...
            {index === 0 && (
              <div className="my-8 flex justify-center">
                <Image src="/images/intj.png" alt="INTJイメージ" width={320} height={320} className="rounded-lg shadow-lg" />
              </div>
            )}
          </div>
        ))}
      ...
      {/* 名人区 */}
      <div className="mt-10">
        <h2 className="text-xl font-semibold mb-4">INTJの有名人</h2>
